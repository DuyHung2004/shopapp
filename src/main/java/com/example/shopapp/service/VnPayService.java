...
public class VnPayService {
    ...
    public String Refund(HttpServletRequest req,VnpayRefund request) throws IOException {
...
//        result.put("responseCode", responseCode);
        ...
        String vnpResponseCode = jsonObject.get("vnp_ResponseCode").getAsString();

        return vnpResponseCode;
    }
    public Map<String, Object> createPayment(HttpServletRequest req, VnpayRequest request) throws Exception {
        String vnp_Version = "2.1.0";
        ...
        result.put("user_id",request.getOrderId());
